...
| Audio | Two of four speakers (CS35L56 sidecar amps) never got audio routed — tweeters only | Fixed locally (signed kernel patch, DKMS + MOK enrollment); confirmed already fixed upstream too, via a different mechanism (Cirrus Logic, merged 2026-07-16, targeting v7.2-rc3) — no submission needed, local patch retires once Fedora ships that kernel | [audio/cs35l56-sidecar-amp-quirk.md](audio/cs35l56-sidecar-amp-quirk.md) |
